 ...
 * 
 * @param {Array of object} collection 
 * @param {condition} pre 
 */
function truthCheck(collection, pre) {
    let lenOfColl = collection.length;
    let lenOfFilteredColl = collection.filter(ele => ele[pre]).length;
    return lenOfColl == lenOfFilteredColl;
}